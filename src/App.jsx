  ...
  const coreCertifications = useMemo(
    () =>
      certifications.filter(
        (cert) => cert.group === 'core',
      ),
    [],
  )

  const specializationCertifications =
    useMemo(
      () =>
        certifications.filter(
          (cert) =>
      ...
      <main>
        ...
        >
          ...
          <div className="hero-copy reveal">
            ...
            <div className="hero-skill-strip">
              <span>
                Azure DevOps
              </span>
            ...
            <div className="quick-links">
              ...
              {/* GitHub is intentionally visible but disabled for now */}
              <a
                aria-disabled="true"
                title="GitHub profile optimization in progress"
              >
                GitHub
        ...
        >
          <SectionHeading
            ...
            copy="Click a project to explore my contribution. Sensitive client data, internal architecture, and proprietary implementation details are intentionally excluded."
          />
        ...
        >
          <SectionHeading
            ...
            copy="Professional certifications and technical specializations across DevOps, Azure, Google Cloud, and AI."
          />
          ...
          <div className="credential-group">
            <div className="credential-group-heading reveal">
              ...
              <div>
                ...
                <h3>
                  Cloud, DevOps & AI credentials
                </h3>
              </div>
            </div>

            <div className="certifications-grid core-grid">
              {coreCertifications.map(
                (cert) => (
                  <CertificationCard
                    cert={cert}
                    key={cert.name}
          ...
          <div className="credential-group specialization-group">
            ...
            <div className="certifications-grid specialization-grid">
              {specializationCertifications.map(
                (cert) => (
                  <CertificationCard
                    cert={cert}
                    compact
